 ...
 * </p>
 * <ul>
 *   <li>{@link MDSDComponentMetamodel.SystemDependant.impl.LinkImpl#getContainers <em>Containers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends NamedElementImpl implements Link {
	...
	protected EClass eStaticClass() {
		return SystemDependantPackage.Literals.LINK;
	}
	...
	public EList<MDSDComponentMetamodel.SystemDependant.Container> getContainers() {
		if (containers == null) {
			containers = new EObjectWithInverseResolvingEList.ManyInverse<MDSDComponentMetamodel.SystemDependant.Container>(
					MDSDComponentMetamodel.SystemDependant.Container.class, this,
					SystemDependantPackage.LINK__CONTAINERS, SystemDependantPackage.CONTAINER__LINKS);
		}
		return containers;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SystemDependantPackage.LINK__CONTAINERS:
