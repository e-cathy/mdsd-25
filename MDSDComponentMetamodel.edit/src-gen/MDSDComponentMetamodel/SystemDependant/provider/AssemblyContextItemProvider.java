...
/**
 * This is the item provider adapter for a {@link MDSDComponentMetamodel.SystemDependant.AssemblyContext} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssemblyContextItemProvider extends NamedElementItemProvider {
	...
	protected void addComponentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				SystemDependantPackage.Literals.ASSEMBLY_CONTEXT__COMPONENT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_AssemblyContext_allocationContext_feature",
								"_UI_AssemblyContext_type"),
						SystemDependantPackage.Literals.ASSEMBLY_CONTEXT__ALLOCATION_CONTEXT, true, false, true, null,
						null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemDependantPackage.Literals.ASSEMBLY_CONTEXT__PROVIDED_ROLES);
			childrenFeatures.add(SystemDependantPackage.Literals.ASSEMBLY_CONTEXT__REQUIRED_ROLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SystemDependantPackage.Literals.ASSEMBLY_CONTEXT__PROVIDED_ROLES,
				SystemDependantFactory.eINSTANCE.createRole()));

		newChildDescriptors.add(createChildParameter(SystemDependantPackage.Literals.ASSEMBLY_CONTEXT__REQUIRED_ROLES,
				SystemDependantFactory.eINSTANCE.createRole()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == SystemDependantPackage.Literals.ASSEMBLY_CONTEXT__PROVIDED_ROLES
				|| childFeature == SystemDependantPackage.Literals.ASSEMBLY_CONTEXT__REQUIRED_ROLES;
