...
/**
 * This is the item provider adapter for a {@link MDSDComponentMetamodel.SystemDependant.Environment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnvironmentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemDependantPackage.Literals.ENVIRONMENT__LINKS);
			childrenFeatures.add(SystemDependantPackage.Literals.ENVIRONMENT__CONTAINERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SystemDependantPackage.Literals.ENVIRONMENT__LINKS,
				SystemDependantFactory.eINSTANCE.createLink()));

		newChildDescriptors.add(createChildParameter(SystemDependantPackage.Literals.ENVIRONMENT__CONTAINERS,
				SystemDependantFactory.eINSTANCE.createContainer()));
	}
