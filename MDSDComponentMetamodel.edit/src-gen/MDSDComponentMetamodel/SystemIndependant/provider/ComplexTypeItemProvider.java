...
/**
 * This is the item provider adapter for a {@link MDSDComponentMetamodel.SystemIndependant.ComplexType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComplexTypeItemProvider extends TypeItemProvider {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ComplexType_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ComplexType_type_feature",
								"_UI_ComplexType_type"),
						SystemIndependantPackage.Literals.COMPLEX_TYPE__TYPE, true, false, false,
	...
	protected void addAttributesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ComplexType_attributes_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ComplexType_attributes_feature",
								"_UI_ComplexType_type"),
						SystemIndependantPackage.Literals.COMPLEX_TYPE__ATTRIBUTES, true, false, true, null, null,
						null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemIndependantPackage.Literals.COMPLEX_TYPE__ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SystemIndependantPackage.Literals.COMPLEX_TYPE__ATTRIBUTES,
				SystemIndependantFactory.eINSTANCE.createParameter()));
	}
