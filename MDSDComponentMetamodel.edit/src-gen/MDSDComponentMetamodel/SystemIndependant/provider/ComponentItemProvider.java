...
/**
 * This is the item provider adapter for a {@link MDSDComponentMetamodel.SystemIndependant.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Component_providedInterfaces_feature",
								"_UI_Component_type"),
						SystemIndependantPackage.Literals.COMPONENT__PROVIDED_INTERFACES, true, false, true, null, null,
						null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Component_requiredInterfaces_feature",
								"_UI_Component_type"),
						SystemIndependantPackage.Literals.COMPONENT__REQUIRED_INTERFACES, true, false, true, null, null,
						null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemIndependantPackage.Literals.COMPONENT__PROVIDED_SERVICES);
			childrenFeatures.add(SystemIndependantPackage.Literals.COMPONENT__BEHAVIOR_DESCRIPTION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SystemIndependantPackage.Literals.COMPONENT__PROVIDED_SERVICES,
				SystemIndependantFactory.eINSTANCE.createService()));

		newChildDescriptors.add(createChildParameter(SystemIndependantPackage.Literals.COMPONENT__BEHAVIOR_DESCRIPTION,
				SystemIndependantFactory.eINSTANCE.createExternalCall()));

		newChildDescriptors.add(createChildParameter(SystemIndependantPackage.Literals.COMPONENT__BEHAVIOR_DESCRIPTION,
				SystemIndependantFactory.eINSTANCE.createInternalAction()));

		newChildDescriptors.add(createChildParameter(SystemIndependantPackage.Literals.COMPONENT__BEHAVIOR_DESCRIPTION,
				SystemIndependantFactory.eINSTANCE.createBranch()));

		newChildDescriptors.add(createChildParameter(SystemIndependantPackage.Literals.COMPONENT__BEHAVIOR_DESCRIPTION,
				SystemIndependantFactory.eINSTANCE.createLoop()));
	}
